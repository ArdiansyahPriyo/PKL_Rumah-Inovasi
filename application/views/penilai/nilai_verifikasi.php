            ...
            <div class="col-lg-11">
              ...
              <table class="table-metadata table-responsive"> 
                <tr>
                  ...
                  <td></td>
                  <td><input type="number" name="nilai_proposal" id="nil_makalah" onkeyup="b()" onblur="a()" class="form-control" style="width: 11%; margin-left: 550px;" min="0" max="100" required oninvalid="this.setCustomValidity('Data wajib diisi!')" oninput="setCustomValidity('')"></td>
              ...
              <table class="table table-hover table-responsive ">
                  ...
                  foreach ($indikator_keterangan as $key => $value):?>
                    <tr>
                      ...
                      <td></td>
                      <td>
                          <input type="number" name="nilai[]" onkeyup="a()" class="form-control tot_nilai" id="nilai_verifikasi" max="<?php echo $keterangan[$key]['nilai'] ?>" min="0" style="width: 40%" required oninvalid="this.setCustomValidity('Data wajib diisi!')" oninput="setCustomValidity('')">    
                      </td>  
                  ...
                  <?php endforeach;?>
                    <tr>
                      ...
                      <td><input type="text" name="total_nilai_komponen" id="tot_nilai_komponen" onblur="b()" class="form-control" style="width: 40%" readonly=""></td>
                    </tr>
            ...
            <div class="col-lg-11">
              <table class="table-metadata table-responsive"> 
                <tr>
                  ...
                  <td></td>
                  <td></td>
                  <td><input type="text" name="nilai_verifikasi" onblur="b()" class="form-control" id="tot_verif" style="width: 25%; margin-left: 190px;" readonly="true"></td>
                </tr>
                <tr>
                  <td></td>
                  <td></td>
