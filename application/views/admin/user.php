      ...
      <div class="modal-body">
        <form action="<?php echo base_url() . 'admin/data_user/tambah_user'; ?>" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group row ml-4">
            ...
            <input type="text" name="nama" style="position: absolute; left: 138px; width: 60%" class="form-control col-sm-8 ml-3" required oninvalid="this.setCustomValidity('Data wajib diisi!')" oninput="setCustomValidity('')" onkeypress="return event.charCode < 48 || event.charCode  >57">
          </div><br>
          ...
          <!-- <div class="form-group row ml-4">
            ...
            <select class="form-control col-sm-8 ml-3" name="satuan_kerja" style="position: absolute; left: 138px; width: 60%">
