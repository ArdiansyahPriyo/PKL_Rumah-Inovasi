							...
							<form method="post" action="<?php echo base_url().'admin/data_nominator/update' ?>">
								...
								<div class= "row">
									<dt for="inputNama" class="col-sm-2 col-form-label">Nilai Minimal</dt>
										<div class="col-sm-5 mb-3">
											<input type="text" name="nilai_komponen_min" class="form-control" value="<?php echo $indpnl->nilai_komponen_min ?>" required>
										</div>
								</div>
								...
								<div class= "row">
									<dt for="inputNama" class="col-sm-2 col-form-label">Nilai Maksimal</dt>
										<div class="col-sm-5 mb-3">
											<input type="text" name="nilai_komponen_max" class="form-control" value="<?php echo $indpnl->nilai_komponen_max ?>" required>
										</div>
								</div>
