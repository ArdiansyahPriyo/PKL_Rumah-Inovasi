						...
						<?php foreach ($user as $usr) : ?>
							<form id="update_user_profil" method="post" action="<?php echo base_url() . 'admin/data_user/update' ?>">
								...
								<!-- <div class="row">
									...
									<div class="col-sm-5 mb-3">
										<select class="form-control" name="satuan_kerja" required>
								...
								<div class="row">
									...
									<div class="col-sm-5 mb-3">
										<select class="form-control" id="hak" name="hak_akses" value="<?php echo $usr->hak_akses ?>">
								...
								<div class="row">
									...
									<div class="col-sm-5 mb-3">
										<select class="form-control" id="status" name="status" value="<?php echo $usr->status ?>">
											<option disabled><?php echo $usr->status ?></option>
...
<script>
	function cek_pwd() {
		...
		if(nama == "" && email == "" && hak == "" && status == ""){
			//$('#modal_cek').appendTo('body').modal('show');
			alert(email);
			return false;
		}else{
