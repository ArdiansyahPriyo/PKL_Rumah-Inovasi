						...
						$no=1;
					      ...
					      <tr>
					        <td align="center"><?php echo $no++ ?></td>
									...
									<?php if ($indikator_penilaian_pemenang == null): ?>
										<td align="center" style="width: 50"> <div class="btn btn-sm btn-danger btn" data-toggle="modal" data-target="#hapus_nominator<?php echo $indpnl->id ?>"><i class="fa fa-trash"></i> <a>Hapus</a></div></td>
								  <?php else: ?>
								  		<?php $id_subevent = $indpnl->id_subevent;?>
											<?php $sql = $this->db->query("SELECT * FROM usulan where (id_subevent='$id_subevent' and status='3')")->result(); ?>
											<?php if ($sql) :?>
											...
											<?php else: ?>
													<td align="center" style="width: 50"><?php echo anchor('admin/data_nominator/edit_indikator/' .$indpnl->id, '<div class="btn btn-sm btn-primary btn"><i class="fa fa-edit"></i>Edit</div>') ?></td> 
													<td align="center" style="width: 50"> <div class="btn btn-sm btn-danger btn" data-toggle="modal" data-target="#hapus_nominator<?php echo $indpnl->id ?>"><i class="fa fa-trash"></i> <a>Hapus</a></div></td>
											<?php endif;?>
									<?php endif; ?>
